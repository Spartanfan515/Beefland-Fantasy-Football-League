...
const CONFIG = {
  ...
  history: [
    ...
    },
    {
      ...
      owner: "Ben Schon",
      record: "10-4",
      note: "Beefland's first champion.",
    },
  ],
  ...
  superlatives: [
    {
      ...
      holder: "Add manager name",
      team: "Add team name",
      value: "Add # of playoff wins",
    },
    {
      category: "Best Win %",
      holder: "Add manager name",
      team: "Add team name",
      value: "Add win % (e.g. .680)",
    },
    {
      category: "Highest Career PPG",
      holder: "Add manager name",
      team: "Add team name",
      value: "Add PPG (e.g. 118.4)",
    },
    {
      category: "Best Regular Season",
      holder: "Add manager name",
      team: "Add team name",
      value: "Add record (e.g. 13-1)",
      note: "Add year",
    },
    {
