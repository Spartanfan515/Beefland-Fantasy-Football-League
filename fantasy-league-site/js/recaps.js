...
const RECAPS = {
  ...
  2024: {
    ...
    overview:
      "Blake Beachnau's Steeler Virginity locked up the No. 1 seed at 10-4, earning a bye alongside Adam Kahler's No. 2 seed Saquon Deez Nuts. The final playoff spot went to Brent Hurlburt's Baby Mama U over Austin Gauss by a comfortable 98-point margin despite identical 8-6 records. Kahler's 189.26-point explosion in Week 14 turned out to be a preview: after his bye, he handled Brent Hurlburt in the semifinals, then upset top-seeded Beachnau in the championship to become the first No. 2 seed to win it all in Beefland history.",
    bracket: [
      {
        label: "Quarterfinals",
        games: [
  ...
  2023: {
    ...
    overview:
      "Jack Callahan's Saquon These Balls put together the best regular season in league history to that point at 11-4, claiming the top seed with a full three-game cushion over the next team out. It didn't matter. Jon Hurlburt's Commissioner of the Year snuck in as the No. 4 seed, immediately knocked off Callahan's No. 1 team in the semifinals, then beat Jacob Ayriss's No. 3 seed in the final to win it all — the first time a lower seed had taken down the league's best regular-season team on the way to a title. Callahan's 208.82-point Week 8 remains one of the best single weeks in franchise history — just not enough to matter in the end.",
    bracket: [
      {
        label: "Semifinals",
        games: [
  ...
  2022: {
    ...
    overview:
      "Zack Rollis's Richmond Diamond Dogs claimed the No. 1 seed at 9-6, part of a crowded five-team logjam all sitting at 9-6 that was separated only by points scored — Austin Gauss grabbed the final playoff spot over Jon Hurlburt by 85 points despite an identical record. Rollis's own best week of the year, 183.92 points in Week 12, came right in the middle of that chase. He beat Gauss in the semifinals, then held off Jacob Ayriss in a low-scoring championship to join Benjamin Schon as a No. 1-seed champion — Beefland's second straight top-seed title.",
    bracket: [
      {
        label: "Semifinals",
        games: [
  ...
  2021: {
    ...
    overview:
      "In Beefland's inaugural season, Benjamin Schon's Nick Foles SZN Champ ran away with the top seed at 10-4. Zach Crook's Save The Bees set the league scoring record that still stands — 211.20 points in Week 14 — and rode a hot finish all the way to the No. 3 seed and a championship appearance, but Schon's team held on to win the first title in franchise history. At the bottom of the playoff race, Jon Hurlburt edged out Evan Lamb for the final spot despite identical 8-6 records, winning the tiebreaker by a lopsided 160.90 points.",
    bracket: [
      {
        label: "Semifinals",
        games: [
